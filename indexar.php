...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/arStyle.css?<?php echo time(); ?>" />
      ...
      <!--   <h1 class="logo me-auto me-lg-0">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li>
              <a class="nav-link scrollto" href="#portfolio">أعمالنا</a>
            </li>
        ...
        >
          <div class="col-xl-2 col-md-4">
            <div class="icon-box">
              ...
              <h3><a href="">الجودة</a></h3>
            </div>
          </div>
          <div class="col-xl-2 col-md-4">
            <div class="icon-box">
            <i  class="bi bi-alarm"></i>
              <h3><a href="">السرعة</a></h3>
            </div>
          </div>
          <div class="col-xl-2 col-md-4">
            <div class="icon-box">
              <i class="ri-calendar-todo-line"></i>
              <h3><a href="">التناسق</a></h3>
            </div>
          </div>
          <div class="col-xl-2 col-md-4">
            <div class="icon-box">
              <i  class="ri-paint-brush-line"></i>
              <h3><a href="">سهولة الإستعمال</a></h3>
            </div>
          </div>
          <div class="col-xl-2 col-md-4">
            <div class="icon-box">
            <i class="bi bi-currency-dollar"></i>
              <h3><a href="">أسعار جيدة</a></h3>
            </div>
          </div>
        </div>
      </div>
...
<!-- End Portfolio Section -->
   ...
   <!--  <section id="testimonials" class="testimonials">
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row mt-5">
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
              <form
                action="forms/contact.php "  onsubmit="alert('سعدنا بتواصلك معنا، وسيقوم فريقنا بالتواصل معك قريباً');" enctype="multipart/form-data"
                method="post"
             ...
             <!---------->
                ...
                <div class="text-center">
                  <button type="submit" class="button-43" name="submit">ارسال </button>
                </div>
                <br>
                  <div>
    ...
    <footer id="footer">
      ...
      <div class="container">
        <div class="copyright">
          جميع الحقوق محفوظة شركة تصميم مواقع الانترنت
